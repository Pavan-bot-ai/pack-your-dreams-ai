...
import { ArrowLeft, User, MapPin, Heart, Plane, Calendar, Phone, Save } from "lucide-react";
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg">Update your travel preferences and personal information</p>
            </div>
          </div>
        </div>
